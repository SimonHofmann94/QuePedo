        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-yellow-50 flex items-center justify-center p-6">
            <Card className="w-full max-w-md p-8 space-y-6">
                <div className="text-center space-y-2">
                    ...
                    <h2 className="text-2xl font-semibold text-slate-900">Start Learning Today</h2>
                    <p className="text-slate-600">Create your free account and begin your Spanish journey</p>
                </div>
